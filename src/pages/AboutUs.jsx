...
//   const handleItemChange = (index, field, value) => {
//     const newItems = [...items];
//     if (field === "qty") newItems[index][field] = Math.max(1, parseInt(value) || 1);
//     else if (field === "discount") newItems[index][field] = Math.min(100, Math.max(0, parseFloat(value) || 0));
//     else if (field === "price") newItems[index][field] = parseFloat(value) || 0;
//     else newItems[index][field] = value;
//     setItems(newItems);
//   };
...
//               onChange={(e) => setWarranty(e.target.checked)}
//               style={{ marginRight: 8 }}
//               aria-label="Include Warranty Claim Instructions"
//             />
//             Include Warranty Claim Instructions
//           </label>
//         </div>
